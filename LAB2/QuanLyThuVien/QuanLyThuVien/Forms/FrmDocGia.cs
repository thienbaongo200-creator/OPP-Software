...
private DocGia LayForm()
        ...
        private void LamMoi()
        {
            ...
            dtNgaySinh.Value = DateTime.Today.AddYears(-18); dtNgayCap.Value = DateTime.Today; dtHan.Value =
            DateTime.Today.AddYears(1); chkLePhi.Checked = true;
        ...
        private void dgvDocGia_SelectionChanged(object sender, EventArgs e)
        {
            ...
            cboPhai.SelectedItem = Convert.ToString(r["Phai"]); txtSDT.Text = Convert.ToString(r["SoDienThoai"]); txtDiaChi.Text =
            Convert.ToString(r["DiaChi"]);
